...
// @TODO: I think the scheduler can go too
SpeedTracker.prototype._processSchedule = function (profile, schedule) {
  ...
  if (schedule) {
    ...
    // @TODO: Key is used here for scheduler. If my goal is a locally-hosted sys-cron oriented application, I think this whole thing can go.
